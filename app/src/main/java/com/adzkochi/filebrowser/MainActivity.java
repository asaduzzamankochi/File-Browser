package com.adzkochi.filebrowser;
...
public class MainActivity extends Activity {
    ...
    private File tempDire = new File("/storage/");
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        secStore = "/storage/extSdCard";

        //currentDir = new File(secStore);
...
//        currentDir = new File(settings.getString("last_dir", "/storage/"));
        ...
        fileListAdapter = new ArrayAdapter<File>(this, R.layout.file_browser_item, 0) {
            ...
            public View getView(final int pos, View convertView, android.view.ViewGroup parent) {
                ...
                holder.fileName.setText(item.getName());
                    if (!item.isFile()) {
                        holder.fileIcon.setImageResource(R.drawable.abc_ab_share_pack_mtrl_alpha);
                    } else {
                        holder.fileIcon.setImageResource(R.drawable.abc_btn_borderless_material);
                    }
                    holder.fileName.setText(item.getName());
